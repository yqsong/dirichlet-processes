...
public class PrepareEmailCorpus {
	protected static double minDFCount = 2;
	protected static double maxDFCount = 10000000;
	protected static int seed = 0;
	
	public List<OpenIntIntHashMap> tfVectors = null;
	public List<int[]> featureSequences = null;
...
//			 Collections.shuffle(permIndex);
	...
	public void loadFeatureVector(double dataPercentage, File stopwordFile) {
        ...
        tfVectors = new ArrayList<OpenIntIntHashMap>(); 
...
//            carrier.setData(null);
	...
	public void loadFeatureSequence(double dataPercentage, File stopwordFile) {
        ...
        alphabet = tflist.getAlphabet();
        featureSequences = new ArrayList<int[]>(); 
	...
	public DocCorpus initializeData (String inputDirectory, String queryStr, boolean isUseTFVector,
			double dataPercentage, double subSampleRate, File stopwordFile) {
    	loadDataString (inputDirectory, queryStr, dataPercentage);
    	
    	DocCorpus docCorpus = null;
    	
    	if (isUseTFVector) {
    		loadFeatureVector(subSampleRate, stopwordFile);
    		docCorpus = new DocCorpus(alphabet, forwardHash, backwardHash,
